...
<section class="responsibility<?php echo $block_classes; ?>">
    ...
    <div class="container container--sm">
        <div class="responsibility__inner">
            ...
            <h2 class="responsibility__title h2"><?php echo $block_data['title']; ?></h2>
            <?php endif; ?>

            <?php if(!empty($block_data['content'])) : ?>
            <p class="responsibility__subtitle"><?php echo $block_data['subtitle']; ?></p>
            <?php endif; ?>
        </div>

        <?php if(!empty($block_data['image'])) : ?>
        <div class="responsibility__image" style="background-image:url(<?php echo $block_data['image']; ?>);">&nbsp;</div>
        <?php endif; ?>

        <div class="responsibility__cols">
            <?php if(!empty($block_data['content']['column_1']['text'])) : ?>
            <div class="responsibility__col">
                <?php if(!empty($block_data['content']['column_1']['lead'])) : ?>
                <h3 class="responsibility__lead"><?php echo $block_data['content']['column_1']['lead']; ?></h3>
                <?php endif; ?>
            ...
            <div class="responsibility__col">
                ...
                <h3 class="responsibility__lead"><?php echo $block_data['content']['column_2']['lead']; ?></h3>
                <?php endif; ?>
