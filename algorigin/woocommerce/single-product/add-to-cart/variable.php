...
<?php if($is_regional_product) : ?>

	<?php // CUSTOM REGIONAL PRODUCT ?>
	...
	<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
		<div class="product-cart">
			...
			<div class="product-cart__options">
				<a href="<?php echo $regional_variation['cart_url']; ?>" value="<?php echo $regional_variation['id']; ?>" class="product-cart__button button button--color-accent button--icon-left ajax_add_to_cart add_to_cart_button js-product-add-to-cart-button" data-product_id="<?php echo $regional_variation['id']; ?>" data-product_sku="<?php echo $regional_variation['sku']; ?>" data-quantity="1"><?php icon_svg('cart', 'button__icon'); ?><?php echo esc_html( $product->single_add_to_cart_text() ); ?></a>
			</div>
