...
<div class="account__login" data-sal="fade">
	...
	<?php endif; ?>
		...
		<div class="login">
			<h2 class="login__title title h2"><?php _e( 'Log in', 'algorigin-theme' ); ?></h2>
			...
			<form class="woocommerce-form woocommerce-form-login" method="post">
				...
				<div class="login__options">
					<div class="login__remember-me checkbox">
						<input class="checkbox__input" name="rememberme" type="checkbox" id="rememberme" value="forever" />
						<label for="rememberme" class="checkbox__label"><?php _e( 'Remember me', 'woocommerce' ); ?></label>
	...
	<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
		...
		<div class="grid__col grid__col--2 grid__col--md">
			...
			<div class="register">
				<h2 class="register__title title h2"><?php _e( 'Register', 'algorigin-theme' ); ?></h2>
