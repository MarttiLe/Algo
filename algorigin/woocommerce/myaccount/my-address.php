...
$dashboard_url = get_permalink($page_refs['account'])
wp_safe_redirect($dashboard_url, 301);
return;
// End redirect
...
<div class="profile__addresses profile__cols woocommerce-Address">
	<?php foreach ( $get_addresses as $name => $address_title ) : ?>
		<?php $address = wc_get_account_formatted_address( $name ); ?>
		<div class="profile__col">
			<h3 class="profile__title woocommerce-Address-title h4"><?php echo esc_html( $address_title ); ?></h3>
