...
<div class="edit-profile">
	...
	<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
		...
		<div class="profile__cols">
			<div class="profile__col">
				<div class="edit-profile__info">
					<h3 class="profile__title h4"><?php esc_html_e( 'Account info', 'algorigin-theme' ); ?></h3>
			...
			<div class="profile__col">
				<div class="edit-profile__password">
					<h3 class="profile__title h4"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></h3>
					<div class="text-field">
						<input type="password" class="text-field__input" name="password_current" id="password_current" placeholder="<?php esc_html_e( 'Current password', 'algorigin-theme' ); ?>" autocomplete="off" />
						<label for="password_current" class="text-field__placeholder"><?php esc_html_e( 'Current password', 'algorigin-theme' ); ?></label>
					</div>
					<div class="text-field">
						<input type="password" class="text-field__input" name="password_1" id="password_1" placeholder="<?php esc_html_e( 'New password', 'algorigin-theme' ); ?>" autocomplete="off" />
						<label for="password_1" class="text-field__placeholder"><?php esc_html_e( 'New password', 'algorigin-theme' ); ?></label>
					</div>
					<div class="text-field">
						<input type="password" class="text-field__input" name="password_2" id="password_2" placeholder="<?php esc_html_e( 'Confirm new password', 'algorigin-theme' ); ?>" autocomplete="off" />
						<label for="password_2" class="text-field__placeholder"><?php esc_html_e( 'Confirm new password', 'algorigin-theme' ); ?></label>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="profile__info-actions loader-button">
